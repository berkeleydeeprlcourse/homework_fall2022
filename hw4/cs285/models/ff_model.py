...
class FFModel(nn.Module, BaseModel):
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        prediction = self(obs, acs, data_statistics["obs_mean"], data_statistics["obs_std"],
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        target = (delta - data_statistics['delta_mean']) / data_statistics['delta_std']
        ...
        prediction = self(observations, actions, data_statistics["obs_mean"], data_statistics["obs_std"],
