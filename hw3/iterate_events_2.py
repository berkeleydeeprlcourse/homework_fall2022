...
logdir1 = "/Users/pratikaher/FALL22/homework_fall2022/hw3/data/q4_1_100_CartPole-v0_12-10-2022_19-55-46/events*"
logdir2 = '/Users/pratikaher/FALL22/homework_fall2022/hw3/data/q4_100_1_CartPole-v0_12-10-2022_18-40-28/events*'
logdir3 = '/Users/pratikaher/FALL22/homework_fall2022/hw3/data/q4_10_10_CartPole-v0_12-10-2022_19-56-18/events*'
...
X, Y_best, Y_average1 = get_section_results(glob.glob(logdir1)[0])
...
plt.plot(X[:49], Y_average1[:100], label='Train_AverageReturn q4_1_100')
plt.plot(X[:49], Y_average2[:100], label='Train_AverageReturn q4_100_1')
plt.plot(X[:49], Y_average3[:100], label='Train_AverageReturn q4_10_10')
...
plt.title("Learning Curve Question 4 ", fontsize=16)
plt.show()
